...
import es.us.dp1.l6_02_24_25.los_mapas_del_reino.configuration.jwt.AuthEntryPointJwt;
import es.us.dp1.l6_02_24_25.los_mapas_del_reino.configuration.jwt.AuthTokenFilter;
import es.us.dp1.l6_02_24_25.los_mapas_del_reino.configuration.services.UserDetailsServiceImpl;
...
public class SecurityConfiguration {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/lobbies/**")).permitAll()
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/players/**")).permitAll()
